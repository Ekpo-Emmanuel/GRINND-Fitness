...
export default function Analytics({ volumeData, muscleGroupData, frequencyData }: { volumeData: any, muscleGroupData: any, frequencyData: any }) {
    ...
    const frequencyConfig = {
      count: { label: 'Workouts', color: 'var(--ds-success)' },
    };
    
    // Create chart config for volume
    const volumeConfig = {
      volume: { label: 'Volume', color: 'var(--ds-accent-purple)' },
    };
    ...
    return (
      <div className="space-y-6">
        {/* Volume Lifted */}
        <Card className="flex flex-col shadow-none bg-[var(--ds-surface)] border border-[color:var(--ds-border)] rounded-xl">
          <CardHeader className="items-center pb-0">
            <CardTitle className="text-[color:var(--ds-text-primary)]">Volume Lifted</CardTitle>
            <CardDescription className="text-[color:var(--ds-text-secondary)]">Total weight lifted over time</CardDescription>
          </CardHeader>
              ...
              >
                ...
                >
                  ...
                  <Line 
                    type="monotone" 
                    dataKey="volume" 
                    stroke="var(--ds-accent-purple)" 
                    strokeWidth={2}
                    dot={{
                      fill: "var(--ds-accent-purple)",
                    }}
                    activeDot={{
                      r: 6,
                    }}
        ...
        <Card className="flex flex-col shadow-none bg-[var(--ds-surface)] border border-[color:var(--ds-border)] rounded-xl">
          <CardHeader className="items-center pb-0">
            <CardTitle className="text-[color:var(--ds-text-primary)]">Muscle Group Focus</CardTitle>
            <CardDescription className="text-[color:var(--ds-text-secondary)]">Training distribution by muscle group</CardDescription>
          </CardHeader>
          <CardContent className="flex-1 pb-0 px-0">
        ...
        <Card className="flex flex-col shadow-none bg-[var(--ds-surface)] border border-[color:var(--ds-border)] rounded-xl">
          <CardHeader className="items-center pb-0">
            <CardTitle className="text-[color:var(--ds-text-primary)]">Workout Frequency</CardTitle>
            <CardDescription className="text-[color:var(--ds-text-secondary)]">Weekly workout consistency (last 6 weeks)</CardDescription>
          </CardHeader>
          <CardContent className="flex-1 pb-0 px-0">
        ...
        <div className="flex justify-center mt-6">
          <button
            ...
            className="px-6 py-2 rounded-lg font-medium flex items-center text-[var(--ds-bg-primary)]"
